...
## k8s工具体系
1. k8scmd([github](https://github.com/shigebeyond/k8scmd)/[gitee](https://gitee.com/shigebeyond/k8scmd)): 精简k8s与 Argo Workflows 命令
2. K8sBoot([github](https://github.com/shigebeyond/K8sBoot)/[gitee](https://gitee.com/shigebeyond/K8sBoot)): 简化k8s资源定义文件
3. ArgoFlowBoot([github](https://github.com/shigebeyond/ArgoFlowBoot)/[gitee](https://gitee.com/shigebeyond/ArgoFlowBoot)): 简化 Argo Workflows 工作流定义文件

## 大数据体系
1. SparkBoot([github](https://github.com/shigebeyond/SparkBoot)/[gitee](https://gitee.com/shigebeyond/SparkBoot)): SparkBoot: yaml 驱动 Spark 开发, 仅编写 yaml与 sql 即可实现复杂的 Spark 编程 
2. ExcelBoot([github](https://github.com/shigebeyond/ExcelBoot)/[gitee](https://gitee.com/shigebeyond/ExcelBoot)): ExcelBoot: yaml 驱动 Excel 生成 

## 自动化测试技术体系
1. HttpBoot([github](https://github.com/shigebeyond/HttpBoot)/[gitee](https://gitee.com/shigebeyond/HttpBoot)): yaml驱动的接口自动化与压测
2. SeleniumBoot([github](https://github.com/shigebeyond/SeleniumBoot)/[gitee](https://gitee.com/shigebeyond/SeleniumBoot)): yaml驱动的web 自动化
3. AppiumBoot([github](https://github.com/shigebeyond/AppiumBoot)/[gitee](https://gitee.com/shigebeyond/AppiumBoot)): yaml驱动的app 自动化
4. MiniumBoot([github](https://github.com/shigebeyond/MiniumBoot)/[gitee](https://gitee.com/shigebeyond/MiniumBoot)): yaml驱动的小程序自动化
5. jktest 测试平台([github](https://www.zhihu.com/zvideo/1630268717249634304)/[gitee](https://www.zhihu.com/zvideo/1630268717249634304)): 基于 flask+vue 3实现，打通4端自动化测试技术
6. HttpRunnerManager([github](https://github.com/shigebeyond/HttpRunnerManager)/[gitee](https://gitee.com/shigebeyond/HttpRunnerManager)): HttpRunnerManager 改造: 根据测试流程与测试团队的需求，改造自动化测试 python 框架 HttpRunnerManager ，支持套件内有序、在报告中输出变量与 curl 命令、请求带 cookie 等功能 
7. swg2hrun([github](https://github.com/shigebeyond/swg2hrun)/[gitee](https://gitee.com/shigebeyond/swg2hrun)): 解析 Swagger api ，自动生成 HttpRunnerManager 测试用例，兼容 Swagger v2 与 v3 版本 

## web框架
1. jkmvc([github](https://github.com/shigebeyond/jkmvc)/[gitee](https://gitee.com/shigebeyond/jkmvc)): 用 kotlin 实现的java web 极速开发框架
```
...
```
2. skmvc([github](https://github.com/shigebeyond/skmvc)/[gitee](https://gitee.com/shigebeyond/skmvc)): skmvc 框架: 使用 php 实现的 mvc/orm 框架 

## 微服务框架
1. jksoa([github](https://github.com/shigebeyond/jksoa)/[gitee](https://gitee.com/shigebeyond/jksoa)): 用 kotlin 实现的 java 微服务框架，组件如下
```
...
2. async4jsonrpc([github](https://github.com/shigebeyond/async4jsonrpc)/[gitee](https://gitee.com/shigebeyond/async4jsonrpc)): 基于asyncio来实现json rpc的python异步框架

## 通用的开发库
1. pyutilb([github](https://github.com/shigebeyond/pyutilb)/[gitee](https://gitee.com/shigebeyond/pyutilb)): python 开发工具类集，涵盖文件读写、日志、时间转换、线程池、图像识别、ThreadLocal 、原子操作、定时器、延迟属性、订阅文件变化、基于 zookeeper 实现的远程配置文件等工具类 
2. jkutil([github](https://github.com/shigebeyond/jkutil)/[gitee](https://gitee.com/shigebeyond/jkutil)): 一些常用的轻量的java工具类
3. jkmq([github](https://github.com/shigebeyond/jkmq)/[gitee](https://gitee.com/shigebeyond/jkmq)): 是封装了多个mq client, 简化mq的生产与消费, 目前仅支持 kafka / rabbitmq / redis, 同时仅 kafka 实现支持广播。 
4. jkjob([github](https://github.com/shigebeyond/jkjob)/[gitee](https://gitee.com/shigebeyond/jkjob)): 是一个轻量级分布式作业调度库
5. jkguard([github](https://github.com/shigebeyond/jkguard)/[gitee](https://gitee.com/shigebeyond/jkguard)): 是流量守护者, 提供了请求合并/流量统计/熔断/限流/降级/缓存等多功能的守护
6. jkcfg([github](https://github.com/shigebeyond/jkcfg)/[gitee](https://gitee.com/shigebeyond/jkcfg)): 配置信息同步器
7. jphp-java-ext([github](https://github.com/shigebeyond/jphp-java-ext)/[gitee](https://gitee.com/shigebeyond/jphp-java-ext)): jphp 扩展，增强 jphp对 java 对象的操作能力; 已集成到 jkmvc/jksoa, 支持在 jvm 上使用 php 语言来实现 web与 rpc, 可做模板与网关等 
8. tenancy([github](https://github.com/shigebeyond/tenancy)/[gitee](https://gitee.com/shigebeyond/tenancy)): 基于 jkmvc 框架的多租户实现, 支持租户识别、日志隔离、db 隔离、缓存隔离、文件系统隔离、分库等特性 

## 低代码开发平台
1. GeekerPlus 低代码开发平台: 未开源，demo: http://jkerp.junianhua.com/jkerp ，账号是admin

## 代码自动生成器
1. codegen([github](https://github.com/shigebeyond/codegen)/[gitee](https://gitee.com/shigebeyond/codegen)): 基于 jkmvc + jphp 实现的的代码生成器，只开源了旧版实现，新版未开源

## idea插件
1. jk-yapix([github](https://github.com/shigebeyond/jk-yapix)/[gitee](https://gitee.com/shigebeyond/jk-yapix)): yapix(idea 插件)改造，支持解析 kotlin 代码、导出 jkmvc 框架的 api 接口、根据 jksoa 框架中的 java 服务接口来生成 php 映射类 

## chrome插件
1. chrome-ext([github](https://github.com/shigebeyond/chrome-ext)/[gitee](https://gitee.com/shigebeyond/chrome-ext)): chrome 扩展，支持以下功能：复制知乎回答、网页剪报、翻译、远程打开、备份标签页、导出 http 请求(导出格式有 curl/HttpRunner/HttpBoot/LocustBoot) 

## 监控
1. MonitorBoot([github](https://github.com/shigebeyond/MonitorBoot)/[gitee](https://gitee.com/shigebeyond/MonitorBoot)): yaml 驱动 linux 系统监控与 jvm 监控与告警 

## 下载器
1. m3u8dwn([github](https://github.com/shigebeyond/m3u8dwn)/[gitee](https://gitee.com/shigebeyond/m3u8dwn)): m3u8视频下载器，支持多协程异步下载 

## 键鼠录制与重放
1. pynput_recorder([github](https://github.com/shigebeyond/pynput_recorder)/[gitee](https://gitee.com/shigebeyond/pynput_recorder)): 键鼠录制与重放

## 小程序组件
1. wechat-components([github](https://github.com/shigebeyond/wechat-components)/[gitee](https://gitee.com/shigebeyond/wechat-components)): 封装了常用的小程序组件
